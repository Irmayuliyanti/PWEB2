...
class dosen
{
    ...
    function __construct($nidn, $prodi){
        $this->nidn = $nidn;
        $this->prodi = $prodi;
    }
...
$dosen1 = new Dosen("220202086", "D3 - Teknik Informatika");
$dosen1->setNama("Irma Yuliyanti");
$dosen2 = new Dosen("220202085", "D4 - Akutansi Lembaga Syari'ah");
...
echo "Prodi: " . $dosen1->getProdi() . "<br><br>";
echo "Dosen 2" . "<br>";
